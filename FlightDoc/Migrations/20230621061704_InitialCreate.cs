        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityStamp = table.Column<string>(type: "nvarchar(max)", nullable: true, defaultValue: "e62a08ca-1617-4e70-a6b5-f40b790e7ad5"),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightAttendantId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlightAttendant", x => x.FlightAttendantId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightCrews_FlightAttendant_FlightAttendantId",
                        column: x => x.FlightAttendantId,
                        principalTable: "FlightAttendant",
                        principalColumn: "FlightAttendantId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserId = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    RoleId = table.Column<string>(type: "nvarchar(100)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2023, 6, 21, 6, 17, 3, 985, DateTimeKind.Utc).AddTicks(7930)),
                    ApplicationUserId = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlightCrews_FlightAttendantId",
                table: "FlightCrews",
